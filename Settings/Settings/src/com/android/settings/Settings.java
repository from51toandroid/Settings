...
public class Settings extends PreferenceActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
		//getView().setBackgroundColor(Color.rgb(0xff, 0xff, 0xff));
		Resources res = getResources();  
         //Drawable drawable = res.getDrawable(R.drawable.selected_self_background);  

         //Drawable drawable = res.getDrawable(new ColorDrawable(Color.RED));  
        ...
        //Log.i( LOG_TAG, "EXTRA_UI_OPTIONS = " + getIntent().hasExtra(EXTRA_UI_OPTIONS) );  
		...
		//Log.i( LOG_TAG, "onIsHidingHeaders = " + onIsHidingHeaders() );  
		//Log.i( LOG_TAG, "onIsMultiPane = " + onIsMultiPane() );  
        ...
        //Log.i( LOG_TAG, "mParentHeader = " + mParentHeader );
        if (mParentHeader != null) {
            setParentTitle(mParentHeader.title, null, new OnClickListener() {
                @Override
                public void onClick(View v) {

				Log.i( LOG_TAG, "onClickddd" );
    ...
    protected boolean isValidFragment(String fragmentName) {
        ...
        for (int i = 0; i < ENTRY_FRAGMENTS.length; i++) {
            if (ENTRY_FRAGMENTS[i].equals(fragmentName)){
                ...
                //Log.i( LOG_TAG, "ENTRY_FRAGMENTS[i] = " + ENTRY_FRAGMENTS[i] );
            }
        }
        return false;
    }
    ...
    private void switchToHeaderLocal(Header header) {
		Log.i( LOG_TAG, "switchToHeaderLocal" );
        mInLocalHeaderSwitch = true;
    ...
    //Log.i( LOG_TAG, "getStartingFragmentClass" );
    ...
    Log.i( LOG_TAG, "onGetInitialHeader" );
    ...
    public Intent onBuildStartFragmentIntent(String fragmentName, Bundle args,
            ...
            //Log.i( LOG_TAG, "onBuildStartFragmentIntent = " + fragmentName );
    ...
    private void updateHeaderList(List<Header> target) {
		//Log.i( LOG_TAG, "updateHeaderList" );
        final boolean showDev = mDevelopmentPreferences.getBoolean(
                DevelopmentSettings.PREF_SHOW,
                android.os.Build.TYPE.equals("eng"));
        int i = 0;
        //Log.i( LOG_TAG, "showDev = " + showDev );
        final UserManager um = (UserManager) getSystemService(Context.USER_SERVICE);
        //Log.i( LOG_TAG, "mHeaderIndexMap = " + mHeaderIndexMap );
        mHeaderIndexMap.clear();

        //Log.i( LOG_TAG, "target.size() = " + target.size() );
        while (i < target.size()) {
    ...
    private int insertAccountsHeaders(List<Header> target, int headerIndex) {
		//Log.i( LOG_TAG, "insertAccountsHeaders" );
    ...
    private boolean updateHomeSettingHeaders(Header header) {
		//Log.i( LOG_TAG, "updateHomeSettingHeaders" );
    ...
    //Log.i( LOG_TAG, "hasNextButton" );
        return super.hasNextButton();
    }

    @Override
    public Button getNextButton() {
    //Log.i( LOG_TAG, "getNextButton" );
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
			...
			//e.fillInStackTrace();
			//Log.i("run stack", "xxx" + this, e);


            
            //Log.i( LOG_TAG, "header = " + header );
            //Log.i( LOG_TAG, "headerType = " + headerType );
            //Log.i( LOG_TAG, "position = " + position );
            //Log.i( LOG_TAG, "convertView = " + convertView );
            //Log.i( LOG_TAG, "parent = " + parent );
            if (convertView == null) {
                ...
                switch (headerType) {
					...
					//Log.i( LOG_TAG, "holder.title = " + holder.title );
				     //Log.i( LOG_TAG, "holder.title.getText() = " + holder.title.getText() );
                        holder.summary = (TextView)
                                view.findViewById(com.android.internal.R.id.summary);
					//Log.i( LOG_TAG, "holder.summary = " + holder.summary );
					//Log.i( LOG_TAG, "holder.summary.getText() = " + holder.summary.getText() );
            ...
            switch (headerType) {
                ...
                case HEADER_TYPE_BUTTON:
					...
					//Log.i( LOG_TAG, "holder.title = " + holder.title );
				     //Log.i( LOG_TAG, "holder.title.getText() = " + holder.title.getText() );
					//Log.i( LOG_TAG, "header.id = " + header.id ); 
					//Log.i( LOG_TAG, "R.id.security_settings = " + R.id.security_settings ); 
                    if (header.id == R.id.security_settings) {
                        boolean hasCert = DevicePolicyManager.hasAnyCaCertsInstalled();
					//Log.i( LOG_TAG, "hasCert = " + hasCert );
        ...
        private void updateCommonHeaderView(Header header, HeaderViewHolder holder) {
			...
			//Log.i( LOG_TAG, "header.extras = " + header.extras );
				     //Log.i( LOG_TAG, "holder.title.getText() = " + holder.title.getText() );
				     
                if (header.extras != null
                        && header.extras.containsKey(ManageAccountsSettings.KEY_ACCOUNT_TYPE)) {

						//Log.i( LOG_TAG, "header.extras 123= " + header.extras );
                ...
                holder.title.setText(header.getTitle(getContext().getResources()));
                //holder.title.setTextColor(0xff0000);
				//Log.i( LOG_TAG, "header.extras 456= " + header.getTitle(getContext().getResources()) );
				
                CharSequence summary = header.getSummary(getContext().getResources());
                if (!TextUtils.isEmpty(summary)) {
					//Log.i( LOG_TAG, "header.extras 789= " + header.extras );
        ...
        private void setHeaderIcon(HeaderViewHolder holder, Drawable icon) {
			...
			//wifi
			//lp.width = 0;
			//holder.icon.setBackgroundColor(Color.rgb(0x36, 0x4b, 0x60));
    ...
    public void onHeaderClick(Header header, int position) {
		...
		//Log.i( LOG_TAG, "header.id = " + header.id );
		//Log.i( LOG_TAG, "R.id.account_add = " + R.id.account_add );
        ...
        if (revert && mLastHeader != null) {
			Log.i( LOG_TAG, "onHeaderClick1" );
            highlightHeader((int) mLastHeader.id);
        } else {
        //Log.i( LOG_TAG, "onHeaderClick2" );
            mLastHeader = header;
        }
    }
