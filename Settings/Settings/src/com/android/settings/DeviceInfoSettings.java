...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    private static final String KEY_SYSTEM_UPDATE_SETTINGS_TEST = "system_update_settings_test";
    ...
    public void onCreate(Bundle icicle) {
		...
		//Log.e( LOG_TAG, "Build.VERSION.RELEASE = " + Build.VERSION.RELEASE );
		...
		//setStringSummary("device_model_test", Build.MODEL);

        //Log.e( LOG_TAG, "Build.DISPLAY = " + Build.DISPLAY );
...
*/
		...
		//Log.e( LOG_TAG, "UserHandle.myUserId() = " + UserHandle.myUserId() );
		//Log.e( LOG_TAG, "UserHandle.USER_OWNER = " + UserHandle.USER_OWNER );
        ...
        removePreferenceIfBoolFalse(KEY_COPYRIGHT, R.bool.config_show_regulatory_info);
        removePreferenceIfBoolFalse(KEY_LICENSE, R.bool.config_show_regulatory_info);

		//getListView().setDivider(new ColorDrawable(Color.YELLOW));
...
//list.setDividerHeight((int) getResources.getDisplayMetrics().density); // or some value > 0
	...
	Log.e( LOG_TAG, "preference.getKey() = " + preference.getKey() );
    ...
    private void setStringSummary(String preference, String value) {
		...
		//Log.e( LOG_TAG, "preference = " + preference );
    ...
    public static String formatKernelVersion(String rawKernelVersion) {
        ...
        //Log.e( LOG_TAG, "rawKernelVersion = " + rawKernelVersion );
